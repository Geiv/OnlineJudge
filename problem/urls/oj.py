...
from ..views.oj import ProblemTagAPI, ProblemAPI, ContestProblemAPI, PickOneAPI, SimpleProblemsAPI

urlpatterns = [
    url(r"^problem/tags/?$", ProblemTagAPI.as_view(), name="problem_tag_list_api"),
    url(r"^problem/?$", ProblemAPI.as_view(), name="problem_api"),
    url(r"^simpleproblems/?$", SimpleProblemsAPI.as_view(), name="simple_problems_api"),
